...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12 text-center">
            <h1><u>PERSENTASE DIVIDEN PENGELOLA & INVESTOR</u></h1>
        </div>
    </div>
            ...
            <table class="table" id="data-table">
                <tr>
                    ...
                    <td><a href="#" data-bs-toggle="modal" data-bs-target="#createInvestor"><img
                                src="{{asset('images/pengelola.svg')}}" width="30"> Tambah Pengelola</a>
...
@include('db.pengelola.create')
@include('db.pengelola.edit')
<div class="container mt-5 table-responsive">
    <table class="table table-bordered table-hover" id="data">
            ...
            <tr>
                ...
                <td class="text-center align-middle">
                    <div class="d-flex justify-content-center">
                        ...
                        <form action="{{route('db.pengelola.delete', $d)}}" method="post" id="deleteForm-{{$d->id}}">
                            @csrf
                            @method('delete')
        ...
        <tfoot>
            <tr>
                <th class="text-end align-middle" colspan="6">Total</th>
...
<script>
    function editInvestor(data, id) {
        ...
        document.getElementById('editForm').action = '/db/pengelola/' + id + '/update';
    }
