...
@include('swal')
@include('db.kreditor.create')
@include('db.kreditor.edit')
            ...
            <tr>
                ...
                <td class="text-center align-middle">
                    <div class="d-flex justify-content-center">
                        ...
                        <form action="{{route('db.kreditor.destroy', $d)}}" method="post" id="deleteForm-{{$d->id}}">
                            @csrf
                            @method('delete')
...
<script>
    function editInvestor(data, id) {
        ...
        document.getElementById('editForm').action = '/db/kreditor/update/' + id;
    }
