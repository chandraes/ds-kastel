    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editInvestorTitle">Edit Packaging</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 mb-3">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="konversi_kemasan" id="edit_konversi_kemasan" required value="{{old('konversi_kemasan')}}">
                            </div>
