    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table table-responsive table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <form action="{{route('db.kategori-inventaris.update', $j->id)}}" method="post"
                                id="updateJabatan">
                                @csrf
                                @method('patch')
                            ...
                            <form action="{{route('db.kategori-inventaris.delete', $j)}}" method="post"
                                class="d-inline">
                                @csrf
                                @method('delete')
                ...
                <form action="{{route('db.kategori-inventaris.store')}}" method="post">
                    @csrf
