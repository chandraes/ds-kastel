...
<div class="container">
    <div class="row justify-content-center mb-5">
        <div class="col-md-12 text-center">
            <h1><u>Edit Biodata Direksi / Staff</u></h1>
        </div>
    </div>
    <form action="{{route('db.staff.update', $data->id)}}" method="post" enctype="multipart/form-data" id="masukForm">
        @csrf
        @method('PATCH')
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                ...
                @endif" name="jabatan_id" id="jabatan_id" required>
                    ...
                    <option value="{{$j->id}}" {{$data->jabatan_id == $j->id ? 'selected' : ''}}>{{$j->nama}}</option>
                    @endforeach
                </select>
        ...
        <div class="row mt-3">
            <div class="col-md-4 mb-3">
                ...
                <div class="input-group mb-3">
                    ...
                    is-invalid
                @endif" name="gaji_pokok" id="gaji_pokok" required data-thousands="." value="{{number_format($data->gaji_pokok, 0,',','.')}}">
                </div>
            ...
            <div class="col-md-4 mb-3">
                ...
                <div class="input-group mb-3">
                    ...
                    is-invalid
                @endif" name="tunjangan_jabatan" id="tunjangan_jabatan" required data-thousands="." value="{{number_format($data->tunjangan_jabatan,0,',','.')}}">
                </div>
                ...
                <div class="row">
                    ...
                    <div class="btn-group" role="group" data-bs-toggle="buttons">
                        ...
                        <label class="btn btn-secondary">
                            <input type="checkbox" class="me-2" name="apa_bpjs_kes" id="apa_bpjs_kes" autocomplete="off" {{$data->apa_bpjs_kes ? 'checked' : ''}} />
                            Ikut BPJS Kesehatan
                        </label>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control @if ($errors->has('bank')) is-invalid @endif" name="bank" id="bank" value="{{$data->bank}}" required>
                @if ($errors->has('bank'))
                <div class="invalid-feedback">
                    {{$errors->first('bank')}}
                </div>
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control @if ($errors->has('no_rek')) is-invalid @endif" name="no_rek" id="no_rek" required value="{{$data->no_rek}}">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control @if ($errors->has('nama_rek')) is-invalid @endif" name="nama_rek" id="nama_rek" required value="{{$data->nama_rek}}">
