...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12 text-center">
            <h1><u>DATABASE COST OPERATIONAL</u></h1>
        </div>
    </div>
            ...
            <table class="table" id="data-table">
                <tr>
                    ...
                    <td><a href="#" data-bs-toggle="modal" data-bs-target="#createInvestor"><img
                                src="{{asset('images/cost-operational.svg')}}" width="30"> Tambah DB</a>
...
@include('db.cost-operational.create')
@include('db.cost-operational.edit')
            ...
            <tr>
                ...
                <td class="text-center align-middle">
                    <div class="d-flex justify-content-center">
                        ...
                        <form action="{{route('db.cost-operational.delete', $d)}}" method="post" id="deleteForm-{{$d->id}}">
                            @csrf
                            @method('delete')
...
<script>
    function editInvestor(data, id) {
        ...
        document.getElementById('editForm').action = '/db/cost-operational/update/' + id;
    }
